...
* Generate reports and monitor restaurant activities
...
| **JavaScript (ES6)**   | Client-side interactivity, form validation, and dynamic UI functionality |
...
* Modular and maintainable PHP codebase
* Improved workflow automation for restaurant operations

---

## 🗄️ Database

The application uses **MySQL** as its relational database and is managed through **phpMyAdmin**. The database is designed to efficiently store and manage:
...
* Real-world restaurant workflow automation
